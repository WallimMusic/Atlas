...
public class AccessManager
{
    ...
    public void SetupConnection()
    {
        ...
        if (Screen != "ERP")
        {
            ...
            string connStr = sr.ReadLine();

            if (connStr == null)
                DevExpress.XtraEditors.XtraMessageBox.Show("Düzgün bağlantı yolu bulunamadı.", "HATA!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            else
                m_Connection.ConnectionString = connStr;
        }
        /* @"Server=.;Database=OSK;User ID=sa;Password =1234"; */
